<!--  Editar Registros -->
<div class="modal fade" id="editarPaciente" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
	
        <div class="modal-content">
            <div class="modal-header">
               
            <h4 class="modal-title-center" id="myModalLabel">Editar Registro</h4>
            </div>
            <div class="modal-body">
			<div class="container-fluid">
			
                <div class="card-body">
						<form method="POST" autocomplete="off"  action="../folder/editarpaciente.php">
							<input type="hidden" id="idPaciente" name="idPaciente">
					<div class="row">
						<div class="col-sm-7">
							<div class="form-group form-group-default">
								<label>RUT</label>
								<input name="dnipa" id="dnipa" type="text" required class="form-control" maxlength="8" placeholder="Ingrese RUT">
							</div>
						</div>
						<div class="col-sm-5">
							<div class="form-group form-group-default">
								<label>Dígito Verificador</label>
								<input name="digito" id="digito" type="text" class="form-control" placeholder="K" readonly>
							</div>
						</div>
						<div class="col-md-6 pr-0">
							<div class="form-group form-group-default">
								<label>Nombre</label>
								<input name="nombrep" id="nombrep" type="text" class="form-control" required placeholder="Ingrese nombre">
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group form-group-default">
								<label>Apellidos</label>
								<input name="apellidop"  id="apellidop" type="text" class="form-control" required placeholder="Ingrese apellidos">
							</div>
						</div>
						...
						<div class="col-md-6">
							<div class="form-group form-group-default">
								...
								<input name="dire" id="dire" type="text" class="form-control" required placeholder="Ingrese dirección">
							</div>
						</div>
						...
						<div class="col-md-6">
							<div class="form-group form-group-default">
								...
								<input name="tele" id="tele" type="number" class="form-control" required placeholder="Ingrese dirección">
							</div>
						</div>
						...
						<div class="col-md-12">
							<div class="form-group form-group-default" required>
								...
								<input name="correo" id="correo" type="email" class="form-control" required placeholder="correo">
							</div>
						</div>
						...
						<div class="col-md-12">
							<div class="form-group form-group-default" required>
								...
								<textarea name="observacion" id="observacion" class="form-control" placeholder="Ingrese observaciones"></textarea>
							</div>
						</div>
