	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<input class="text" name="codpaci" type="hidden" value="<?php echo $row['codpaci']; ?>">
					<div class="row">
						<div class="col-sm-12">
						...
						<div class="col-sm-12">
							<div class="form-group form-group-default">
								...
								<input type="date" class="form-control" name="fechanacimiento" value="<?php echo $row['fecha_nacimiento']; ?>">
							</div>
						</div>
