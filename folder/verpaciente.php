...
<div class="modal fade" id="addRowModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <h4 class="modal-title-center" id="myModalLabel">Editar Paciente</h4>
            </div>
					...
					<div class="row">
						<div class="col-sm-7">
							<div class="form-group form-group-default">
								<label>RUT</label>
								<input name="dnipa" type="text" required class="form-control" maxlength="8" placeholder="Ingrese RUT" value="<?php echo $row['motivo_consulta_p']; ?>">
							</div>
						</div>
						<div class="col-sm-5">
							<div class="form-group form-group-default">
		 ...
		 <div class="modal-footer">
                ...
                <button type="submit" name="agregar" onclick="funcionAlerta()" class="btn btn-primary"><span class="glyphicon glyphicon-floppy-disk"></span> Editar</button>
			</form>
                </div>
